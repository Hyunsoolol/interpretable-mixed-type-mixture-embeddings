...
## 4. Main Simulation: concentration-driven setting
...
| method | MSE_kappa | MSE_eta_contrast | kappa ratio | eta contrast norm |
|---|---:|---:|---:|---:|
| Rossi | 1.327 | 0.247 | 10.149 | 181.370 |
| Rossi + refit | 1.406 | 0.362 | 10.040 | 181.025 |
| 분리 패널티 | 1.330 | 0.241 | 10.143 | 181.342 |
| 분리 패널티 + refit | 1.422 | 0.391 | 10.034 | 181.052 |
| 에타 패널티 | 9.254 | 0.360 | 8.428 | 174.767 |
| 에타 패널티 + refit | 1.249 | 0.179 | 10.052 | 180.828 |
...
## 6. 추가 Simulation 1: concentration 차이가 약한 경우
...
| method | ARI | selected q | FPR | F1 | MSE_eta_contrast | kappa ratio |
|---|---:|---:|---:|---:|---:|---:|
| Rossi | 0.363 | 41.133 | 0.346 | 0.502 | 0.252 | 2.023 |
| Rossi + refit | 0.349 | 41.133 | 0.346 | 0.502 | 0.523 | 1.988 |
| 분리 패널티 | 0.360 | 35.133 | 0.279 | 0.585 | 0.355 | 2.008 |
| 분리 패널티 + refit | 0.356 | 35.133 | 0.279 | 0.585 | 0.457 | 1.993 |
| 에타 패널티 | 0.343 | 11.467 | 0.016 | 0.935 | 0.421 | 1.623 |
| 에타 패널티 + refit | 0.367 | 11.467 | 0.016 | 0.935 | 0.188 | 2.001 |
...
## 7. 추가 Simulation 2: 평균과 집중도 차이가 모두 있는 경우
...
| method | ARI | selected q | FPR | F1 | MSE_eta_contrast | kappa ratio |
|---|---:|---:|---:|---:|---:|---:|
| Rossi | 0.995 | 12.467 | 0.027 | 0.895 | 0.157 | 5.057 |
| Rossi + refit | 0.995 | 12.467 | 0.027 | 0.895 | 0.110 | 5.034 |
| 분리 패널티 | 0.995 | 13.700 | 0.041 | 0.855 | 0.165 | 5.061 |
| 분리 패널티 + refit | 0.995 | 13.700 | 0.041 | 0.855 | 0.131 | 5.033 |
| 에타 패널티 | 0.994 | 11.633 | 0.018 | 0.944 | 0.364 | 4.210 |
| 에타 패널티 + refit | 0.995 | 11.633 | 0.018 | 0.944 | 0.107 | 5.029 |
...
6. 에타 패널티 + refit은 support를 유지하면서 `MSE_kappa`, `MSE_eta_contrast`, `kappa ratio`, `eta norm`을 true value에 가깝게 개선했다.
