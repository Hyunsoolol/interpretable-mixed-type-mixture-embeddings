...
|---|---:|---:|---:|---:|
| 공통 $\kappa$ | 26.3 | 37.3 | 2.5 | 2.5 |
| 이질적 $\kappa$ | 51.5 | 58.3 | 3.0 | 4.3 |
| 공통 $\eta$ | 60.4 | 56.1 | 3.2 | 3.9 |

M 계열은 `EM + ADMM + product-of-spheres update`, E 계열은
`EM + closed-form group proximal update`를 사용한다. M 계열은 R 기반
진단 구현, E 계열은 Rcpp backend이므로 위 시간은 현재 구현 기준이다.
