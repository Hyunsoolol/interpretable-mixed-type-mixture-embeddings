...
$$
\widehat{e}_B(A) = \frac{1}{M} \sum_{m=1}^{M} \mathbf{1} \left\{ \underset{k}{\arg\max} \ P(Z_m=k \mid X_m; \Theta(A)) \neq Z_m \right\}, \qquad A^* : \widehat{e}_B(A^*) \simeq e_B^{\mathrm{target}}
$$
