...
| 모형 | ARI | selected q | common q | specific q | noise q | TPR | FPR | Precision | F1 | MSE_mu | MSE_kappa | MSE_eta |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| D-L | 0.031 | 198.56 | 4.00 | 16.00 | 178.56 | 1.000 | 0.992 | 0.081 | 0.149 | 0.002 | 112.405 | 4.395 |
| D-GL | 0.027 | 18.18 | 4.00 | 4.20 | 9.98 | 0.263 | 0.076 | 0.200 | 0.284 | 0.001 | 749.811 | 5.370 |
| D-AGL | 0.039 | 20.64 | 4.00 | 4.88 | 11.76 | 0.305 | 0.086 | 0.184 | 0.342 | 0.001 | 345.094 | 3.318 |
| E-L | 0.029 | 193.48 | 3.78 | 15.82 | 173.88 | 0.989 | 0.966 | 0.082 | 0.151 | 0.002 | 121.131 | 4.691 |
...
- 모든 모형에서 ARI가 거의 0에 가깝고, E-GL은 BIC에서 zero support를 선택했다.
...
- S1-S4 전체에서 decision-support recovery 기준으로는 E-AGL이 가장 안정적이다. S5/S6는 평균 방향 차이를 30도 수준으로 낮춘 stress 진단으로 별도 해석한다.
...
| 모형 | ARI | selected q | common q | specific q | noise q | TPR | FPR | Precision | F1 | MSE_mu | MSE_kappa | MSE_eta |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| D-L | 0.023 | 198.52 | 4.00 | 79.50 | 115.02 | 0.994 | 0.992 | 0.400 | 0.571 | 0.002 | 113.941 | 4.499 |
| D-GL | 0.001 | 16.56 | 4.00 | 7.02 | 5.54 | 0.088 | 0.080 | 0.331 | 0.170 | 0.001 | 197.466 | 3.096 |
| D-AGL | 0.005 | 16.80 | 4.00 | 7.48 | 5.32 | 0.094 | 0.078 | 0.293 | 0.201 | 0.001 | 483.095 | 4.417 |
| E-L | 0.025 | 188.22 | 3.70 | 75.88 | 108.64 | 0.949 | 0.936 | 0.403 | 0.565 | 0.002 | 114.674 | 4.693 |
| E-GL | NA | 0.00 | 0.00 | 0.00 | 0.00 | 0.000 | 0.000 | NA | NA | NA | NA | NA |
...
| 모형 | ARI | selected q | common q | specific q | noise q | TPR | FPR | Precision | F1 | MSE_mu | MSE_kappa | MSE_eta |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| D-L | 0.012 | 197.56 | 4.00 | 79.10 | 114.46 | 0.989 | 0.987 | 0.401 | 0.570 | 0.002 | 165.369 | 5.141 |
| D-GL | 0.001 | 15.82 | 4.00 | 4.98 | 6.84 | 0.062 | 0.090 | 0.208 | 0.135 | 0.001 | 97.965 | 2.418 |
| D-AGL | 0.002 | 10.96 | 4.00 | 3.06 | 3.90 | 0.038 | 0.066 | 0.163 | 0.108 | 0.001 | 119.271 | 2.260 |
| E-L | 0.011 | 187.38 | 3.78 | 75.44 | 108.16 | 0.943 | 0.933 | 0.403 | 0.564 | 0.002 | 125.599 | 4.964 |
| E-GL | NA | 0.00 | 0.00 | 0.00 | 0.00 | 0.000 | 0.000 | NA | NA | NA | NA | NA |
