...
아래 표는 6개 비교 모형 전체 결과를 난이도별로 나누어 정리한 것이다. 결과 파일의 `E-L`, `E-GL`, `E-AGL` 행은 문서의 명명 체계에 맞춰 각각 E-CL, E-CGL, E-CAGL로 표기했다. `MSE_eta`는 `MSE_centered_eta`를 뜻한다.

#### 5.2.1 target \(e_B=2.5\%\)

Calibration은 equal kappa에서 2.42%, heterogeneous kappa에서 2.54%로 맞춰졌다.

| n | kappa | method | selected q | common q | decision q | noise q | F1 | ARI | MSE_eta |
|---:|:---|:---|---:|---:|---:|---:|---:|---:|---:|
| 300 | equal | D-L | 199.64 | 4.00 | 16.00 | 179.64 | 0.148 | 0.889 | 2.441 |
| 300 | equal | D-GL | 40.26 | 4.00 | 16.00 | 20.26 | 0.569 | 0.924 | 0.742 |
| 300 | equal | D-AGL | 48.34 | 4.00 | 16.00 | 28.34 | 0.497 | 0.918 | 0.898 |
| 300 | equal | E-CL | 197.82 | 3.98 | 16.00 | 177.84 | 0.150 | 0.890 | 2.434 |
| 300 | equal | E-CGL | 17.94 | 0.06 | 16.00 | 1.88 | 0.943 | 0.932 | 0.277 |
| 300 | equal | E-CAGL | 17.92 | 0.00 | 16.00 | 1.92 | 0.943 | 0.931 | 0.257 |
| 300 | heterogeneous | D-L | 199.64 | 4.00 | 16.00 | 179.64 | 0.148 | 0.882 | 2.451 |
| 300 | heterogeneous | D-GL | 47.58 | 3.52 | 16.00 | 28.06 | 0.503 | 0.924 | 0.879 |
| 300 | heterogeneous | D-AGL | 55.04 | 3.70 | 16.00 | 35.34 | 0.450 | 0.911 | 1.026 |
| 300 | heterogeneous | E-CL | 197.96 | 3.92 | 16.00 | 178.04 | 0.150 | 0.884 | 2.445 |
| 300 | heterogeneous | E-CGL | 18.90 | 0.08 | 16.00 | 2.82 | 0.917 | 0.932 | 0.306 |
| 300 | heterogeneous | E-CAGL | 18.00 | 0.02 | 16.00 | 1.98 | 0.941 | 0.933 | 0.264 |
| 1000 | equal | D-L | 199.58 | 4.00 | 16.00 | 179.58 | 0.148 | 0.920 | 0.676 |
| 1000 | equal | D-GL | 20.00 | 4.00 | 16.00 | 0.00 | 0.889 | 0.935 | 0.066 |
| 1000 | equal | D-AGL | 20.00 | 4.00 | 16.00 | 0.00 | 0.889 | 0.935 | 0.066 |
| 1000 | equal | E-CL | 197.56 | 3.96 | 16.00 | 177.60 | 0.150 | 0.920 | 0.675 |
| 1000 | equal | E-CGL | 17.02 | 0.02 | 16.00 | 1.00 | 0.969 | 0.935 | 0.069 |
| 1000 | equal | E-CAGL | 16.04 | 0.00 | 16.00 | 0.04 | 0.999 | 0.935 | 0.053 |
| 1000 | heterogeneous | D-L | 199.58 | 4.00 | 16.00 | 179.58 | 0.148 | 0.921 | 0.669 |
| 1000 | heterogeneous | D-GL | 20.04 | 3.86 | 16.00 | 0.18 | 0.888 | 0.935 | 0.065 |
| 1000 | heterogeneous | D-AGL | 20.06 | 3.90 | 16.00 | 0.16 | 0.887 | 0.935 | 0.065 |
| 1000 | heterogeneous | E-CL | 197.58 | 3.92 | 16.00 | 177.66 | 0.150 | 0.922 | 0.669 |
| 1000 | heterogeneous | E-CGL | 17.20 | 0.04 | 16.00 | 1.16 | 0.964 | 0.934 | 0.070 |
| 1000 | heterogeneous | E-CAGL | 16.04 | 0.00 | 16.00 | 0.04 | 0.999 | 0.935 | 0.051 |

#### 5.2.2 target \(e_B=5.0\%\)

Calibration은 equal kappa에서 4.58%, heterogeneous kappa에서 4.54%로 맞춰졌다.

| n | kappa | method | selected q | common q | decision q | noise q | F1 | ARI | MSE_eta |
|---:|:---|:---|---:|---:|---:|---:|---:|---:|---:|
| 300 | equal | D-L | 199.80 | 4.00 | 16.00 | 179.80 | 0.148 | 0.786 | 2.701 |
| 300 | equal | D-GL | 41.80 | 4.00 | 16.00 | 21.80 | 0.554 | 0.863 | 0.780 |
| 300 | equal | D-AGL | 63.80 | 4.00 | 16.00 | 43.80 | 0.401 | 0.835 | 1.268 |
| 300 | equal | E-CL | 198.12 | 3.84 | 16.00 | 178.28 | 0.149 | 0.794 | 2.675 |
| 300 | equal | E-CGL | 17.30 | 0.04 | 16.00 | 1.26 | 0.961 | 0.871 | 0.264 |
| 300 | equal | E-CAGL | 16.76 | 0.00 | 16.00 | 0.76 | 0.977 | 0.875 | 0.231 |
| 300 | heterogeneous | D-L | 199.60 | 4.00 | 16.00 | 179.60 | 0.148 | 0.764 | 2.897 |
| 300 | heterogeneous | D-GL | 44.06 | 4.00 | 16.00 | 24.06 | 0.533 | 0.853 | 0.857 |
| 300 | heterogeneous | D-AGL | 70.80 | 4.00 | 16.00 | 50.80 | 0.369 | 0.814 | 1.533 |
| 300 | heterogeneous | E-CL | 198.18 | 3.96 | 16.00 | 178.22 | 0.149 | 0.768 | 2.838 |
| 300 | heterogeneous | E-CGL | 17.94 | 0.10 | 16.00 | 1.84 | 0.943 | 0.868 | 0.303 |
| 300 | heterogeneous | E-CAGL | 18.24 | 0.04 | 16.00 | 2.20 | 0.935 | 0.868 | 0.288 |
| 1000 | equal | D-L | 199.60 | 4.00 | 16.00 | 179.60 | 0.148 | 0.852 | 0.719 |
| 1000 | equal | D-GL | 20.00 | 4.00 | 16.00 | 0.00 | 0.889 | 0.878 | 0.070 |
| 1000 | equal | D-AGL | 20.00 | 4.00 | 16.00 | 0.00 | 0.889 | 0.878 | 0.070 |
| 1000 | equal | E-CL | 197.44 | 3.90 | 16.00 | 177.54 | 0.150 | 0.852 | 0.718 |
| 1000 | equal | E-CGL | 17.04 | 0.00 | 16.00 | 1.04 | 0.969 | 0.879 | 0.072 |
| 1000 | equal | E-CAGL | 16.12 | 0.00 | 16.00 | 0.12 | 0.996 | 0.879 | 0.058 |
| 1000 | heterogeneous | D-L | 199.72 | 4.00 | 16.00 | 179.72 | 0.148 | 0.848 | 0.720 |
| 1000 | heterogeneous | D-GL | 20.00 | 4.00 | 16.00 | 0.00 | 0.889 | 0.875 | 0.067 |
| 1000 | heterogeneous | D-AGL | 20.00 | 4.00 | 16.00 | 0.00 | 0.889 | 0.875 | 0.067 |
| 1000 | heterogeneous | E-CL | 197.70 | 3.96 | 16.00 | 177.74 | 0.150 | 0.848 | 0.720 |
| 1000 | heterogeneous | E-CGL | 17.30 | 0.02 | 16.00 | 1.28 | 0.961 | 0.876 | 0.075 |
| 1000 | heterogeneous | E-CAGL | 16.06 | 0.00 | 16.00 | 0.06 | 0.998 | 0.876 | 0.056 |

#### 5.2.3 target \(e_B=10.0\%\)

Calibration은 equal kappa에서 11.24%, heterogeneous kappa에서 10.52%로 맞춰졌다.

| n | kappa | method | selected q | common q | decision q | noise q | F1 | ARI | MSE_eta |
|---:|:---|:---|---:|---:|---:|---:|---:|---:|---:|
| 300 | equal | D-L | 199.52 | 4.00 | 16.00 | 179.52 | 0.148 | 0.429 | 4.392 |
| 300 | equal | D-GL | 33.48 | 4.00 | 15.94 | 13.54 | 0.644 | 0.671 | 2.736 |
| 300 | equal | D-AGL | 51.72 | 4.00 | 15.92 | 31.80 | 0.470 | 0.631 | 1.337 |
| 300 | equal | E-CL | 198.08 | 3.98 | 16.00 | 178.10 | 0.149 | 0.438 | 4.436 |
| 300 | equal | E-CGL | 17.18 | 0.04 | 16.00 | 1.14 | 0.964 | 0.700 | 0.308 |
| 300 | equal | E-CAGL | 16.98 | 0.00 | 15.54 | 1.44 | 0.942 | 0.700 | 0.348 |
| 300 | heterogeneous | D-L | 199.62 | 4.00 | 16.00 | 179.62 | 0.148 | 0.526 | 4.516 |
| 300 | heterogeneous | D-GL | 39.36 | 4.00 | 15.80 | 19.56 | 0.571 | 0.627 | 9.682 |
| 300 | heterogeneous | D-AGL | 70.86 | 4.00 | 16.00 | 50.86 | 0.368 | 0.594 | 7.104 |
| 300 | heterogeneous | E-CL | 198.22 | 3.92 | 16.00 | 178.30 | 0.149 | 0.522 | 4.556 |
| 300 | heterogeneous | E-CGL | 21.88 | 0.18 | 15.52 | 6.18 | 0.819 | 0.688 | 0.852 |
| 300 | heterogeneous | E-CAGL | 21.48 | 0.12 | 14.88 | 6.48 | 0.794 | 0.681 | 0.814 |
| 1000 | equal | D-L | 199.74 | 4.00 | 16.00 | 179.74 | 0.148 | 0.653 | 0.886 |
| 1000 | equal | D-GL | 20.10 | 4.00 | 16.00 | 0.10 | 0.886 | 0.719 | 0.085 |
| 1000 | equal | D-AGL | 20.02 | 4.00 | 16.00 | 0.02 | 0.888 | 0.720 | 0.083 |
| 1000 | equal | E-CL | 198.48 | 4.00 | 16.00 | 178.48 | 0.149 | 0.653 | 0.886 |
| 1000 | equal | E-CGL | 17.34 | 0.04 | 16.00 | 1.30 | 0.960 | 0.719 | 0.088 |
| 1000 | equal | E-CAGL | 16.24 | 0.00 | 16.00 | 0.24 | 0.993 | 0.720 | 0.069 |
| 1000 | heterogeneous | D-L | 199.98 | 4.00 | 16.00 | 179.98 | 0.148 | 0.660 | 1.068 |
| 1000 | heterogeneous | D-GL | 25.12 | 4.00 | 16.00 | 5.12 | 0.778 | 0.734 | 0.159 |
| 1000 | heterogeneous | D-AGL | 24.14 | 4.00 | 16.00 | 4.14 | 0.797 | 0.734 | 0.119 |
| 1000 | heterogeneous | E-CL | 199.28 | 4.00 | 16.00 | 179.28 | 0.149 | 0.662 | 1.075 |
| 1000 | heterogeneous | E-CGL | 20.36 | 0.06 | 16.00 | 4.30 | 0.880 | 0.736 | 0.120 |
| 1000 | heterogeneous | E-CAGL | 21.66 | 0.18 | 16.00 | 5.48 | 0.850 | 0.735 | 0.114 |
