...
\citet{rossi2022sparsevmf} uses its event-driven path with at most 240 updates
in the primary simulations. E-CGL and E-ACGL use the zero-augmented 240-point
...
\[
\zeta=\sqrt{1+z^2}+\log\frac{z}{1+\sqrt{1+z^2}},\qquad
U_1(p)=\frac{3p-5p^3}{24},\qquad
U_2(p)=\frac{81p^2-462p^4+385p^6}{1152}.
\]
