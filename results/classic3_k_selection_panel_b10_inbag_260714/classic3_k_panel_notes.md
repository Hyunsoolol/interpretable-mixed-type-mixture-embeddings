...
- Candidate K={2,3,4,5,6,7,8,9,10}; bootstrap reps=10; bootstrap nstart=5.
...
- Bootstrap elapsed seconds: 657.7.
...
| shared | bootstrap_OOB_NLL_min | 10 | -4913.689 |
| shared | bootstrap_OOB_NLL_1SE | 10 | -4912.702 |
| shared | bootstrap_pairwise_stability | 3 | 0.995 |
...
| free | bootstrap_OOB_NLL_min | 10 | -4919.248 |
| free | bootstrap_OOB_NLL_1SE | 10 | -4918.257 |
